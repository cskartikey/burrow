...
const TITLE = {
    'en-US': 'Burrow through Firewalls',
}
...
const config: DocsThemeConfig = {
    ...
    head: function useHead() {
        ...
        const description =
            ...
            'Burrow is a tool developed by teenagers at Hack Club to bypass firewalls!'
        const image =
    ...
    logo: function Logo() {
        ...
        return (
            <>
                ...
                <span
                    className="hidden select-none font-extrabold ltr:ml-2 rtl:mr-2 md:inline text-hackClubRed font-PhantomSans"
    ...
    project: {
        link: 'https://github.com/hackclub/burrow'
    },
    sidebar: {
        autoCollapse: true,
